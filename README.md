...
In this tutorial, we'll learn how to build a persistent UI using React state and local storage. We'll see how to set user input on the component state, persisting the user's changes in the browser's local storage to survive refreshes.
